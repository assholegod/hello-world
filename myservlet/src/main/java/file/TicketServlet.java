...
public class TicketServlet extends HttpServlet {
	...
	void viewTicket(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
